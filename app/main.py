...
# Include routers
from app.routers import templates_router, locations_router, admin_router, logs_router
...
# Location endpoints moved to app/routers/locations.py
...
# Phase template endpoints moved to app/routers/templates.py
