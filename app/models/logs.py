...
class LogEntry(Base):
    """Log entry model for plant-specific logs."""
    ...
    phase = Column(String(50), nullable=True)  # 'feeding', 'curing', etc.
...
class EnvironmentLog(Base):
    """Environment log model for device/location environmental data."""
